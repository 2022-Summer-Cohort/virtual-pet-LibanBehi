...
public class OrganicCat extends OrganicPet{
    ...
    public void greeting() {
        System.out.println("Organic cat " + petName + " I Am a Organic Pet!" + " My Hunger Level Is " + hungerLevel + " My Boredom Level Is " + boredomLevel + " My Litter Box is " + cleanliness );
    }
}
